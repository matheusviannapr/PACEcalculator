...
\begin{frame}{\nomesembateria\ -- \cliente}
  ...
  \end{tabelachave}
  \notaderodape{Sem armazenamento, o sistema desliga junto com a rede: é exigência de segurança da norma de conexão, não limitação do equipamento. \origemdopreco}
\end{frame}
\fi

\ifsplitseco
\begin{frame}{\nomesecobateria\ -- \cliente}
  \framesubtitle{\notasecobateria}
  \vspace{0.05cm}\centering
  \begin{tabelachave}[4.6cm]{4.2cm}
    \linha{Solução}{\nomesecobateria}
    \linha{Potência do Sistema}{\potenciaprojeto}
    \linha{Geração Anual}{\geracaoanual}
    \linhadestaque{Investimento}{\invsecobateria}
    \linha{Economia Anual}{\economiaanualsecobateria}
    \linha{Economia Mensal}{\economiamensalsecobateria}
    \linha{Mensalidade (\prazofinanciamentocurto)}{\mensalidadesecobateria}
    \linha{Payback simples}{\paybacksecobateria}
    \linha{Autonomia na falta de energia}{Nenhuma, até instalar o banco}
  \end{tabelachave}
  \notaderodape{O inversor híbrido já fica instalado: acrescentar as baterias depois é somar o banco, sem trocar o equipamento. \origemdopreco}
\end{frame}
\fi

\ifsplit
\begin{frame}{\nomecombateria\ -- \cliente}
  \framesubtitle{\notacombateria}
  \vspace{0.05cm}\centering
  \begin{tabelachave}[4.6cm]{4.2cm}
    \linha{Solução}{\nomecombateria}
  ...
  \end{tabelachave}
  \notaderodape{A autonomia é a garantida no pior horário e na pior estação do ano, com a carga do quadro de backup deste estudo. \origemdopreco}
\end{frame}
\fi
...
\begin{frame}{Compra do Sistema -- \cliente}
  ...
  \begin{tabelachave}[4.2cm]{4.2cm}
    ...
    \linha{Valor do Sistema}{\investimentocurto}
    \linhadestaque{Entrada}{\entradafinanciamento}
    \linha{Valor Financiado}{\valorfinanciado}
...
% ============================================================================
\newcommand{\linhafluxo}[3]{#1 & #2 & #3 \\ \hline}
\begin{frame}{Retorno Financeiro Estimado -- \cliente}
  \framesubtitle{Fluxo de caixa acumulado}
  \vspace{0.15cm}
  \begin{minipage}[c]{0.46\textwidth}
    \begin{tabeladados}{|\colrotulo{0.9cm}|*{2}{\colvalor{2.2cm}|}}
      \hline
      \cab{Ano} & \cab{À vista} & \cab{Financiado} \\ \hline
      \linhasfluxo
    \end{tabeladados}
  \end{minipage}\hfill
